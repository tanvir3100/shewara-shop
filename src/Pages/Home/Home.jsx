...
const Home = () => {
    ...
    const filteredCollection = filterBrand ? collection.filter(item => item.brand_name.toLowerCase() === filterBrand) : collection;
        ...
        <div className='p-4'>
            ...
            <div className='ml-5'>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
                    {
                        filteredCollection.map(item => <div key={item.id} className="card bg-base-100 border rounded-none">
